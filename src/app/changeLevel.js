...
const ChangeLevel = ({ level, setLevel, isRightAnswer, setRightAnswer, setTaskBird, setClickedBird, score, setScore, setGameFinish }) => {
    return (<div>
        {!isRightAnswer && <DisableButton setLevel={setLevel} />}
        {isRightAnswer && (level < 5) && <AbleButton level={level} setLevel={setLevel} setTaskBird={setTaskBird} setRightAnswer={setRightAnswer} setClickedBird={setClickedBird} score={score} setScore={setScore} />}
